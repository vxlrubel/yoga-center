...
@push('title', 'About yoga center | Yoga Center')
...
@section('content')
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="about-item icon-box">
						<div class="ai-icon">
							<img src="/assets/img/icons/about-4.png" alt="">
						</div>
						<div class="ai-text">
							<h4>Slim Body</h4>
	...
	<!-- What we do Section -->
	<section class="wwd-section spad set-bg" data-setbg="assets/img/wwd-bg.jpg">
		<div class="container">
			<div class="row">
